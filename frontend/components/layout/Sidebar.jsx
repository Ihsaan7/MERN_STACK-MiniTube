  ...
  return (
    ...
    >
      <nav className="flex flex-col gap-2 px-4">
        ...
        <button onClick={() => navigate("/subscriptions")} className={navBtn(isDark)}>
        ...
        <button onClick={() => navigate("/liked-videos")} className={navBtn(isDark)}>
          <LikeIcon /> <span>Liked Videos</span>
        </button>
        <button onClick={() => navigate("/playlists")} className={navBtn(isDark)}>
          <PlaylistIcon /> <span>Playlists</span>
        </button>
        <button onClick={() => navigate("/dashboard")} className={navBtn(isDark)}>
          <AnalyticsIcon /> <span>Analytics</span>
        </button>
        {user && (
          <button onClick={() => navigate("/profile")} className={navBtn(isDark)}>
...
function SubsIcon() {
  return (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 11v9" />
    </svg>
  );
}
function LibraryIcon() {
  return (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 19V5a2 2 0 012-2h12a2 2 0 012 2v14" />
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 17V7" />
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17V7" />
    </svg>
  );
}
...
function AnalyticsIcon() {
  return (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 17a2 2 0 104 0v-5a2 2 0 10-4 0v5z" />
